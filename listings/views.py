            ...
            with transaction.atomic():
                if userlisting_id:
                    ...
                    if this_listing.exists():
                        ...
                        userlisting.save()
                        return Response({"Message":"listings has been increased"})
                    else:
                        ...
                        userlisting.total += listing.price
                        userlisting.save()
                        return Response({"Message":"A new housing added to the lists"})
                    ...
                    userlisting.total += listing.price
                    userlisting.save()
                    return Response({"Message":"New listing group created"})
...
class CheckoutView(APIView):
    def post(self,request):
        ...
        try:
            ...
            return Response({"Error":"Listing does not exist"}, status=status.HTTP_400_BAD_REQUEST)
